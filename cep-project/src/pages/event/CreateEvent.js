            ...
            <div className="form-container form-group create-event-form"> 
                <div className='row'>
                    ...
                    <div className='col-md-6'>
                        ...
                        <label htmlFor="inputGenres" className="create-label">Please indicate which of the following genres best describe your event. You can select as many options as you wish.</label><br/>
